...
- `helpers/testing/generated-documentation-source.spec.ts` keeps tenant general-settings
  ...
  `apply(...)`, inline `bind(...)(...)`, and `Reflect.apply(...)`, and rejects
  ...
  rejects screenshots before the first Markdown section and more than two
  screenshots after one Markdown section so generated images stay close to the
  explanatory text that gives them product context, follows aliased Markdown
