...
test('Restore an existing sign-up payment', async ({
  database,
  page,
  registerDatabaseCleanup,
  seeded,
...
For an open page, Evorto confirms that the payment link was restored. The attendee can return to the event and continue paying; the place remains reserved until payment finishes. If the original page has already completed or expired, Evorto instead checks its final status through normal reconciliation.
