...
`,
  ...
  await takeScreenshot(
    ...
    page,
    'Messages needing attention first, with sent history below',
  );
...
- Messages marked **Could not send** or **Delivery not confirmed**, and messages that have been sending longer than expected, appear first. Each priority group shows the most recently updated messages first.
...
A signed-in member who does not manage Evorto as a whole sees the forbidden page when opening **Email delivery** directly. Being an Admin for one organization does not open this page for all organizations.
