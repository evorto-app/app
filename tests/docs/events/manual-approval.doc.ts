...
4. Wait for **Your ticket is pending organizer approval**.
...
If the approval email does not arrive, the attendee can still reopen the event and continue payment.
`,
    });
    await approveButton.click();
    await expect(
