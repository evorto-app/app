...
For unpaid registrations, organizers can transfer a not-yet-checked-in participant registration to another eligible tenant member. Paid registrations stay unavailable for direct organizer-assisted transfer and use participant-created transfer codes for replacement checkout and source refund handling.
