...
export const getCityTripTemplates = (cityTripsCategory: {
...
}) => [
  {
    ...
    title: 'Augsburg Trip',
    planningTips: '<h3>Planning Tips</h3><ul><li>Coordinate with local guides for an informative tour.</li><li>Ensure participants have comfortable walking shoes.</li><li>Plan for a break at a local café or park.</li></ul>',
  },
  {
    categoryId: cityTripsCategory.id,
    description:
    ...
    planningTips: '<h3>Planning Tips</h3><ul><li>Plan the itinerary to include major landmarks and attractions.</li><li>Ensure participants have a map and emergency contact information.</li><li>Schedule free time for participants to explore on their own.</li></ul>',
  },
  {
    categoryId: cityTripsCategory.id,
    description:
