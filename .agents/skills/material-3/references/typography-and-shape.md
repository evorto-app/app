...
.md3-dialog-enter {
  animation: dialog-enter var(--md-sys-motion-duration-medium4) var(--md-sys-motion-easing-emphasized-decelerate);
}
...
/* Example: fade out */
.md3-fade-out {
  animation: fade-out var(--md-sys-motion-duration-short4) var(--md-sys-motion-easing-emphasized-accelerate);
}
