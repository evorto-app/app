...
- Observed PR #62 active-head CI cleanup checkpoint: after pushing local head
  `17fdcfd5`, the current PR rollup shows CodeQL, CodeQL `Analyze (actions)`,
  ...
  pushed head. E2E run `27063722044` completed all three serialized worker
