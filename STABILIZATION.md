...
with small cleanup commits around evidence drift, relaunch-scope watchpoints,
Browser setup recovery, and richer authenticated Browser evidence as those
surfaces change. ESNcard provider add/refresh/remove outcomes now use
