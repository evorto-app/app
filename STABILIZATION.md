...
- Observed PR #62 active-head CI cleanup checkpoint: after pushing local head
  `36c6f524`, the current PR rollup shows CodeQL, CodeQL `Analyze (actions)`,
  ...
  pushed head. E2E run `27065005139` completed all three serialized worker
