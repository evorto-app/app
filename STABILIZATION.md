...
Latest coverage checkpoint: generated-doc weak Markdown body source coverage
now explicitly pins optional-call Markdown attachment syntax before enforcing
the 120-character explanatory body minimum. The guard covers
...
Local validation for the slice passed `bun run format:write`,
`bun run lint`,
