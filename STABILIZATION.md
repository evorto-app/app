...
- Observed PR #62 active-head CI cleanup checkpoint: after pushing local head
  `9672416e`, the current PR rollup shows CodeQL, CodeQL `Analyze (actions)`,
  ...
  pushed head. E2E run `27066380325` completed all three serialized worker
