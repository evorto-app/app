...
- `tests/docs/template-categories/categories.doc.ts` documents template
  category create/edit with focused screenshots for the create form, saved row,
  edit form, and renamed row, plus deterministic category names, database
  readbacks for created and edited rows, and cleanup of the generated category.
