...
test.describe('Checkout Tax Rate Integration', () => {
  test('checkout uses exact displayed price without adding tax @finance @taxRates @checkout', async ({
    page,
    events,
  }) => {
    ...
    const paidOption = paidEvent.registrationOptions.find((o) => o.isPaid);
  ...
  test('checkout attaches tax rate identifier for compliance @finance @taxRates @checkout', async ({
    page,
    events,
  }) => {
  ...
  test('checkout continues when tax rate becomes unavailable @finance @taxRates @checkout', async ({
    page,
    events,
  }) => {
  ...
  test('free registration skips tax rate processing @finance @taxRates @checkout', async ({
    page,
    events,
    registrations,
    tenant,
    ...
    const eventWithFreeOptions = events.find((event) => {
      ...
      const hasFreeOption = event.registrationOptions.some((option) => !option.isPaid);
  ...
  test('discounted price to zero treated as free @finance @taxRates @checkout', async ({
    page,
    events,
  }) => {
  ...
  test('payment request includes correct tax rate metadata @finance @taxRates @checkout', async ({
    page,
    events,
  }) => {
  ...
  test('inactive tax rate warning logged during checkout @finance @taxRates @checkout', async ({
    page,
    events,
  }) => {
