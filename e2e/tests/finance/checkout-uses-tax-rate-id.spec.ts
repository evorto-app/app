...
test.describe('Checkout Tax Rate Integration', () => {
  ...
  test('checkout attaches tax rate identifier for compliance @finance @taxRates @checkout', async ({ page, events }) => {
  ...
  test('discounted price to zero treated as free @finance @taxRates @checkout', async ({ page, events }) => {
  ...
  test('inactive tax rate warning logged during checkout @finance @taxRates @checkout', async ({ page, events }) => {
