...
export const registrationRefundWorkerRuntimeModeConfig = Config.all({
  ...
  Config.mapOrFail(
    ({ E2E_NOW_ISO, E2E_RUNTIME_MODE, NEON_LOCAL_PROXY, NODE_ENV }) => {
      ...
      return validatedLocalPlaywrightRuntime
        ...
        : Effect.fail(
            configFailure(
              'E2E_RUNTIME_MODE=playwright may disable the registration refund worker only with NODE_ENV=development, NEON_LOCAL_PROXY=true, and E2E_NOW_ISO configured',
            ),
          );
    },
  ),
