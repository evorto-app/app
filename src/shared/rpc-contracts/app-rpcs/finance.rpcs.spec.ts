...
describe('receipt media public error encoding', () => {
  it('keeps internal receipt storage causes outside public error payloads', () => {
    ...
    expect(encodedPayloads).toEqual([
      {
        _tag: 'ReceiptMediaInternalError',
        message: 'Receipt storage failed internally',
      },
      {
        _tag: 'ReceiptMediaServiceUnavailableError',
        message: 'Receipt storage is unavailable',
      },
    ]);
