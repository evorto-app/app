  ...
  return value
    .map((item) =>
      isKnownPermission(item)
        ...
        : (additionalPermissionLabels[item] ??
...
const platformAuditActionLabels = {
  ...
  'event.updateListing': 'Event listing changed',
  'receipt.reimburse': 'Receipt reimbursement recorded',
  'receipt.review': 'Receipt reviewed',
  'refundClaim.requeue': 'Registration refund requeued',
  ...
  'taxRates.import': 'Tax rates imported',
