...
Recheck event availability, captured prices and discounts, and selected add-on terms after acquiring registration locks. Reject concurrent setup changes before recording a sign-up, waitlist entry, approval, or payment claim, and ask the user to review the current details.
