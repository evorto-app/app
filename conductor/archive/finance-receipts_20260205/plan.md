...
- [x] Task: Conductor - User Manual Verification 'Discovery + Data Design' (Protocol in workflow.md)
...
- [x] Task: Implement API for receipt submission and retrieval [05bb914]
  ...
  - [x] Accept image or PDF attachment and store R2 attachment reference
- [x] Task: Event organization UI - receipt list + add receipt flow [05bb914]
  ...
  - [x] Integrate R2 upload + receipt name support
...
- [x] Task: Conductor - User Manual Verification 'Receipt Submission (Backend + UI)' (Protocol in workflow.md)
...
- [x] Task: Conductor - User Manual Verification 'Approval Flow' (Protocol in workflow.md)
...
- [x] Task: Conductor - User Manual Verification 'Refund Flow + Transactions' (Protocol in workflow.md)
...
- [x] Task: UI/UX polish and accessibility checks
