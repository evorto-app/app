...
1. Continue decommissioning remaining tRPC user/event/finance/template surfaces into Effect RPC slices (next likely high-traffic event read/mutation paths such as `events.findOne`/`eventList` and related guards, plus discount card mutations).
