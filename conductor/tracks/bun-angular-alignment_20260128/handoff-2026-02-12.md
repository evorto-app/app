...
1. Continue decommissioning remaining tRPC admin/user/event surfaces into Effect RPC slices (next likely `admin.tenant` and finance/event read-heavy domains).
